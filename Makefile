...
prepare:
	mogrify -resize 96x96 -background white -alpha remove -alpha off ./sprites/devops/*.png
	mogrify -resize 96x96 -background white -alpha remove -alpha off ./sprites/d365/*.png
